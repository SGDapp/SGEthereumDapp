...
//console.log(web3NodeB.isConnected());



var appRouter = function(app) {
var wallet = require('./features/payements.js')(app,web3NodeA,web3NodeB);
//var escrow = require('./features/escrow.js')(app,web3NodeB);
//var digitizingDocs = require('./features/digitizingDocs.js')(app,web3NodeB);
//var letterOfCredit = require('./features/letterOfCreditjs')(app,web3NodeB);
